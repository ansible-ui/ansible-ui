...
async def handler_game_workflow_roles(request):
...
async def handler_game_ansible_list(request):
    dir_path = request.app['settings'].ansible_game_workspace
...
async def handler_game_ansible_read(request):
    post = await request.post()
...
async def handler_game_ansible_write(request):
    post = await request.post()
...
async def handler_game_ws_ansible_run(request):
